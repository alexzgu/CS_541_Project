...
| S13 dataset v2 Tier 1+2 | **yes — Tier 1 adopted; Tier 2 pilot APPLIED** | Tier 1: 4,290 rows recovered, `data.version = clean_v2` adopted (champion SER 0.263 / timed-F1 0.710 on v2 refs); `gold_v2` built. Tier 2 pilot: user reviewed `s13_pilot/` player and approved — songs 23 (+660 as-sung kana morae) & 21 (+281) applied 2026-07-16 (backups `data/clean_v2/subtitles_pre_tier2/`; priors refit: 46.9k segments). Song 81 items still need user's ear / official lyrics (test-song no-model-drafting policy) |
